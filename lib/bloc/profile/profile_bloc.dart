...
class ProfileBloc extends Bloc<ProfileEvent, ProfileState> {
  ...
  ProfileBloc({@required UserRepository userRepository}): assert(userRepository != null), 
  ...
  Stream<ProfileState>_mapSubmittedToState({File photo, String name, String userId, String gender,
